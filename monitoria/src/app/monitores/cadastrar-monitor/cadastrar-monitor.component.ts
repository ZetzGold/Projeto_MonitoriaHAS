...
@Component({
  selector: 'app-cadastrar-monitor',
  templateUrl: './cadastrar-monitor.component.html',
  styleUrls: ['./cadastrar-monitor.component.css']
})
export class CadastrarMonitorComponent {
